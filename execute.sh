...
-fo $OUTPUT_PATH/obs_pre_christophe_coop_08.txt \
-pp $OUTPUT_PATH/par_christophe_coop_08.par \
...
-p param.save \
-fo $OUTPUT_PATH/obs_pre_christophe_08.txt \
-pp $OUTPUT_PATH/par_christophe_08.par \
-i $INPUT_PATH/factor_info.txt \
-r $INPUT_PATH/rep.txt \
-o Direct	# modelOption: Logistic, Direct, Quenching, ChrMod_Unlimited, ChrMod_Limite
done
